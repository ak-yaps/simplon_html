var td = (function() {
    ...
    function recupererPositions() {
        ...
        for (i = 0; i < sections.length; i += 1) {
            ...
            bounding = sections[i].getBoundingClientRect();
            // on récupère donc les positions de chaque pane par rapport à la page
            positions[sections[i].id] = bounding.top;
        ...
        console.log("positions des sections en pixels une fois la page chargée => ");
    ...
    function scroller() {
        ...
        idCible = this.getAttribute("href");
